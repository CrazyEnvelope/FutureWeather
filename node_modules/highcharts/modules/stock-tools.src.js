...
class NavigationBindings {
    ...
    static compose(AnnotationClass, ChartClass) {
        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pushUnique)(composed, 'NavigationBindings')) {
            ...
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(NavigationBindings, 'closePopup', onNavigationBindingsClosePopup);
...
function manageIndicators(data) {
    ...
    if (data.actionType === 'edit') {
        ...
        seriesConfig.id = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.uniqueKey)();
        this.fieldsToOptions(data.fields, seriesConfig);
        ...
        if (typeof parentSeries !== 'undefined' &&
            ...
            !(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(defaultOptions && defaultOptions[seriesConfig.type] &&
        ...
        if (indicatorsWithAxes.indexOf(data.type) >= 0) {
            yAxis = chart.addAxis({
                id: (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.uniqueKey)(),
                offset: 0,
                opposite: true,
                title: {
                    text: ''
...
function updateHeight(e, annotation) {
    const options = annotation.options.typeOptions, yAxis = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(options.yAxis) && this.chart.yAxis[options.yAxis];
...
function updateNthPoint(startIndex) {
    return function (e, annotation) {
        const options = annotation.options.typeOptions, xAxis = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(options.xAxis) && this.chart.xAxis[options.xAxis], yAxis = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(options.yAxis) && this.chart.yAxis[options.yAxis];
        if (xAxis && yAxis) {
...
function updateRectSize(event, annotation) {
    const chart = annotation.chart, options = annotation.options.typeOptions, xAxis = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(options.xAxis) && chart.xAxis[options.xAxis], yAxis = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(options.yAxis) && chart.yAxis[options.yAxis];
    if (xAxis && yAxis) {
...
function shallowArraysEqual(a, b) {
    if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(a) || !(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(b)) {
        return false;
    }
...
const StockToolsBindings = {
    ...
    segment: {
        ...
        start: function (e) {
            ...
            const navigation = this.chart.options.navigation, options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)({
                langKey: 'segment',
                type: 'crookedLine',
                typeOptions: {
                    xAxis: coordsX.axis.index,
    ...
    crooked3: {
        ...
        start: function (e) {
            ...
            const x = coordsX.value, y = coordsY.value, navigation = this.chart.options.navigation, options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)({
                langKey: 'crooked3',
                type: 'crookedLine',
                typeOptions: {
                    xAxis: coordsX.axis.index,
    ...
    seriesTypeHLC: {
        ...
        init: function (button) {
            ...
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.fireEvent)(this, 'deselectButton', { button });
        }
    },
    /**
...
function navigationGetYAxisPositions(yAxes, plotHeight, defaultHeight, removedYAxisProps) {
    ...
    function isPercentage(prop) {
        return (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(prop) && !(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(prop) && prop.match('%');
    }
    if (removedYAxisProps) {
        removedTop = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.correctFloat)((parseFloat(removedYAxisProps.top) / 100));
        removedHeight = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.correctFloat)((parseFloat(removedYAxisProps.height) / 100));
    }
    const positions = yAxes.map((yAxis, index) => {
        let height = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.correctFloat)(isPercentage(yAxis.options.height) ?
            parseFloat(String(yAxis.options.height)) / 100 :
            yAxis.height / plotHeight), top = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.correctFloat)(isPercentage(yAxis.options.top) ?
        ...
        if (!removedHeight) {
            ...
            if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(top)) {
                top = allAxesHeight;
            }
            previousAxisHeight = height;
            allAxesHeight = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.correctFloat)(Math.max(allAxesHeight, (top || 0) + (height || 0)));
        }
        else {
...
function navigationRecalculateYAxisPositions(positions, changedSpace, modifyHeight, adder) {
    positions.forEach(function (position, index) {
        ...
        position.top = !prevPosition ? 0 :
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.correctFloat)(prevPosition.height + prevPosition.top);
        if (modifyHeight) {
            position.height = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.correctFloat)(position.height + adder * changedSpace);
        }
    });
    return positions;
}
...
function navigationResizeYAxes(removedYAxisProps) {
    ...
    if (!removedYAxisProps &&
        allAxesHeight <= (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.correctFloat)(0.8 + defaultHeight / 100)) {
        positions[positions.length - 1] = {
            height: defaultHeight,
            top: (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.correctFloat)(allAxesHeight * 100 - defaultHeight)
        };
    }
    else {
...
class Toolbar {
    ...
    createButtons() {
        ...
        buttons.forEach((btnName) => {
            ...
            this.eventsToUnbind.push((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(button.buttonWrapper, 'click', () => this.eraseActiveButtons(allButtons, button.buttonWrapper)));
            if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(defs[btnName].items)) {
    ...
    addSubmenu(parentBtn, button) {
        const submenuArrow = parentBtn.submenuArrow, buttonWrapper = parentBtn.buttonWrapper, buttonWidth = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.getStyle)(buttonWrapper, 'width'), wrapper = this.wrapper, menuWrapper = this.listWrapper, allButtons = this.toolbar.childNodes, title = buttonWrapper.title, 
        // Create submenu container
        submenuWrapper = this.submenu = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('ul', {
        ...
        // Show / hide submenu
        this.eventsToUnbind.push((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(submenuArrow, 'click', (e) => {
            e.stopPropagation();
            ...
            if (buttonWrapper.className
                ...
                menuWrapper.style.width = menuWrapper.startWidth +
                    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.getStyle)(menuWrapper, 'padding-left') +
    ...
    addSubmenuItems(buttonWrapper, button) {
        ...
        items.forEach((btnName) => {
            ...
            this.eventsToUnbind.push((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(submenuBtn.mainButton, 'click', function () {
    ...
    addButton(target, options, btnName, lang = {}) {
        ...
        const mainButton = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)(elementType, {
        ...
        if (items && items.length) {
            ...
            const submenuArrow = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('button', {
    ...
    addNavigation() {
        ...
        // Arrow wrapper
        this.arrowWrapper = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('div', {
            className: 'highcharts-arrow-wrapper'
        });
        this.arrowUp = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('div', {
        ...
        this.arrowDown = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('div', {
    ...
    scrollButtons() {
        ...
        let targetY = 0;
        this.eventsToUnbind.push((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(this.arrowUp, 'click', () => {
            if (targetY > 0) {
                targetY -= step;
                toolbar.style.marginTop = -targetY + 'px';
            }
        }));
        this.eventsToUnbind.push((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(this.arrowDown, 'click', () => {
    ...
    createContainer() {
        ...
        const wrapper = this.wrapper = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('div', {
            className: 'highcharts-stocktools-wrapper ' +
                guiOptions.className + ' ' + bindingsClassName,
            ariaHidden: false
        });
        container.appendChild(wrapper);
        this.showHideBtn = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('div', {
            className: 'highcharts-toggle-toolbar highcharts-arrow-left'
        }, void 0, wrapper);
        // Toggle menu
        this.eventsToUnbind.push((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(this.showHideBtn, 'click', () => {
            this.update({
                gui: {
        ...
        [
            ...
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(wrapper, eventType, (e) => e.stopPropagation());
        });
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(wrapper, 'mouseover', (e) => chart.pointer?.onContainerMouseLeave(e));
        // Toolbar
        this.toolbar = toolbar = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('ul', {
            className: 'highcharts-stocktools-toolbar ' +
                guiOptions.toolbarClassName,
            ariaLabel: groupLabel
        });
        // Add container for list of buttons
        this.listWrapper = listWrapper = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('div', {
    ...
    showHideToolbar() {
        ...
        if (!visible) {
            ...
            showHideBtn.style.top = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.getStyle)(toolbar, 'padding-top') + 'px';
            showHideBtn.style.left = (wrapper.offsetWidth +
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.getStyle)(toolbar, 'padding-left')) + 'px';
        }
    }
    /*
     ...
     */
    updateVisibility() {
        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(this.options.visible)) {
...
function chartSetStockTools(options) {
    const chartOptions = this.options, lang = chartOptions.lang, guiOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(chartOptions.stockTools && chartOptions.stockTools.gui, options && options.gui), langOptions = lang && lang.stockTools && lang.stockTools.gui;
...
function StockToolsGui_compose(ChartClass, NavigationBindingsClass) {
    ...
    if (!chartProto.setStockTools) {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartClass, 'beforeRender', onChartBeforeRedraw);
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartClass, 'destroy', StockToolsGui_onChartDestroy);
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartClass, 'getMargins', onChartGetMargins, { order: 0 });
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartClass, 'render', StockToolsGui_onChartRender);
        chartProto.setStockTools = chartSetStockTools;
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(NavigationBindingsClass, 'deselectButton', StockToolsGui_onNavigationBindingsDeselectButton);
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(NavigationBindingsClass, 'selectButton', onNavigationBindingsSelectButton);
...
function setOffset(chart) {
    if (chart.stockTools?.guiEnabled) {
        ...
        const offsetWidth = listWrapper && ((listWrapper.startWidth +
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.getStyle)(listWrapper, 'padding-left') +
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.getStyle)(listWrapper, 'padding-right')) || listWrapper.offsetWidth);
