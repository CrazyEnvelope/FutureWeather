...
function chartRemoveAnnotation(idOrAnnotation) {
    const annotations = this.annotations, annotation = (idOrAnnotation.coll === 'annotations') ?
        idOrAnnotation :
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.find)(annotations, function (annotation) {
...
class EventEmitter {
    ...
    addEvents() {
        const emitter = this, addMouseDownEvent = function (element) {
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(element, isTouchDevice ? 'touchstart' : 'mousedown', (e) => {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)(emitter.options.events, (event, type) => {
...
class ControlPoint extends Annotations_EventEmitter {
     ...
     */
    update(userOptions) {
        const chart = this.chart, target = this.target, index = this.index, options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(true, this.options, userOptions);
        this.destroy();
...
(function (ControlTarget) {
    ...
    function addControlPoints() {
        ...
        controlPointsOptions.forEach((controlPointOptions, i) => {
            const options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(this.options.controlPointOptions, controlPointOptions);
            if (!options.index) {
                options.index = i;
            }
...
class Controllable {
     ...
     */
    update(newOptions) {
        const annotation = this.annotation, options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(true, this.options, newOptions), parentGroup = this.graphic.parentGroup, Constructor = this.constructor;
        this.destroy();
...
function svgRendererAddMarker(id, markerOptions) {
    ...
    const ast = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(true, {
        attributes: {
            markerWidth: 20,
            markerHeight: 20,
            refX: 0,
...
class ControllablePath extends Controllables_Controllable {
    ...
    render(parent) {
        ...
        super.render();
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(this.graphic, { markerStartSetter, markerEndSetter });
     ...
     */
    setMarkers(item) {
        const itemOptions = item.options, chart = item.chart, defs = chart.options.defs, fill = itemOptions.fill, color = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(fill) && fill !== 'none' ?
            fill :
            itemOptions.stroke;
...
class ControllableRect extends Controllables_Controllable {
    ...
    redraw(animation) {
        if (this.graphic) {
            ...
            if (position) {
                const xAxis = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(this.options.xAxis) ?
                    this.chart.xAxis[this.options.xAxis] : void 0, yAxis = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(this.options.yAxis) ?
...
class ControllableCircle extends Controllables_Controllable {
    ...
    redraw(animation) {
        if (this.graphic) {
            ...
            if (position) {
                const yAxis = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(this.options.yAxis) ?
                    this.chart.yAxis[this.options.yAxis] : void 0;
                if (yAxis && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(point.y)) {
...
class BaseForm {
    ...
    createPopupContainer(parentDiv, className = 'highcharts-popup highcharts-no-tooltip') {
        return (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('div', { className }, void 0, parentDiv);
    }
    /**
    ...
    addCloseButton(className = 'highcharts-popup-close') {
        ...
        const closeButton = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('button', { className }, void 0, this.container);
        ...
        ['click', 'touchstart'].forEach((eventName) => {
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(closeButton, eventName, this.closeButtonEvents.bind(this));
        });
        // Close popup when press ESC
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(document, 'keydown', (event) => {
...
function addForm(chart, options, callback, isInit) {
    ...
    let lhsCol = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('h2', {
    ...
    const bottomRow = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('div', {
...
function addToolbar(chart, options, callback) {
    ...
    // Create label
    const label = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('p', {
...
function addFormFields(parentDiv, chart, parentNode, options, storage, isRoot) {
    ...
    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)(options, (value, option) => {
    ...
    if (isRoot) {
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.stableSort)(storage, (a) => (a[1].match(/format/g) ? -1 : 1));
        if (isFirefox) {
...
function addColsContainer(container) {
    // Left column
    const lhsCol = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('div', {
        className: 'highcharts-popup-lhs-col'
    }, void 0, container);
    // Right column
    const rhsCol = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('div', {
...
function addIndicatorList(chart, parentDiv, listType, filter) {
    ...
    const indicatorList = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('ul', {
    ...
    filteredSeriesArray.forEach((seriesSet) => {
        ...
        const btn = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('button', {
...
function addParamInputs(chart, parentNode, fields, type, parentDiv) {
    ...
    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)(fields, (value, fieldName) => {
        // Create name like params.styles.fontSize
...
function addSearchBox(chart, parentDiv) {
    ...
    const input = this.addInput(options, 'input', inputWrapper, inputAttributes), button = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('a', {
...
function addSelection(indicatorType, optionName, parentDiv) {
    ...
    const selectBox = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('select', {
        name: selectName,
...
function filterSeries(series, filter) {
    ...
    let filteredSeries;
    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)(series, (series, value) => {
...
function addMenuItem(tabName, disableTab) {
    ...
    // Tab 1
    const menuItem = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('button', {
        className
    }, void 0, popupDiv);
...
class Popup extends Shared_BaseForm {
    ...
    constructor(parentDiv, iconsURL, chart) {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(this.container, 'mousedown', () => {
            const activeAnnotation = chart &&
                chart.navigationBindings &&
                chart.navigationBindings.activeAnnotation;
            if (activeAnnotation) {
                activeAnnotation.cancelClick = true;
                const unbind = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(Popup_doc, 'click', () => {
                    setTimeout(() => {
    ...
    addInput(option, indicatorType, parentDiv, inputAttributes) {
        ...
        // Add input
        const input = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('input', {
            name: inputName,
    ...
    createColorInput(option, inputName, inputAttributes, parentDiv, container) {
        ...
        const wrapper = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('div', { className: 'highcharts-popup-color-wrapper' }, void 0, parentDiv);
        const colorInput = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('input', {
            type: 'color',
            value,
            className: ('highcharts-popup-field highcharts-popup-field-color')
        }, void 0, wrapper);
        const textInput = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('input', {
            name: inputName,
            id: inputName,
            value,
            type: 'text',
        ...
        const separator = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('span', { className: 'highcharts-popup-color-separator' }, void 0, wrapper);
        const opacityPercentInput = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('input', {
            type: 'number',
        ...
        const opacityPercentSuffix = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('span', { className: 'highcharts-popup-opacity-percent-suffix' }, void 0, wrapper);
        opacityPercentSuffix.appendChild(Popup_doc.createTextNode(' %'));
        const opacitySlider = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('input', {
            type: 'range',
            value: String(Math.round(opacity * 100)),
        ...
        const syncOpacityInputs = (e) => {
            const target = e.target, val = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(Number(target.value), 0, 100);
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(parentDiv, 'mousedown', (e) => {
            if (e.target !== opacityPercentInput &&
                e.target !== opacitySlider) {
                opacitySlider.style.display = 'none';
            }
        });
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(opacityPercentInput, 'focus', () => {
    ...
    addButton(parentDiv, label, type, fieldsDiv, callback) {
        const button = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('button', void 0, void 0, parentDiv);
        button.appendChild(Popup_doc.createTextNode(label));
        if (callback) {
            ['click', 'touchstart'].forEach((eventName) => {
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(button, eventName, () => {
                    this.closePopup();
...
function getLabelsAndShapesOptions(baseOptions, newOptions) {
    ...
    ['labels', 'shapes'].forEach((name) => {
        ...
        if (someBaseOptions) {
            if (newOptionsValue) {
                mergedOptions[name] = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)(newOptionsValue).map((basicOptions, i) => (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(someBaseOptions[i], basicOptions));
            }
            else {
...
class Annotation extends Annotations_EventEmitter {
    ...
    initLabel(labelOptions, index) {
        ...
        const options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(this.options.labelOptions, {
    ...
    initShape(shapeOptions, index) {
        const options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(this.options.shapeOptions, {
            controlPointOptions: this.options.controlPointOptions
    ...
    update(userOptions, redraw) {
        const chart = this.chart, labelsAndShapes = getLabelsAndShapesOptions(this.userOptions, userOptions), userOptionsIndex = chart.annotations.indexOf(this), options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(true, this.userOptions, userOptions);
...
function onChartRender() {
    ...
    if (this && navigationBindings) {
        ...
        if (this.navigationBindings &&
            ...
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)(navigationBindings.boundClassNames, (value, key) => {
...
class NavigationBindings {
    ...
    static compose(AnnotationClass, ChartClass) {
        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pushUnique)(NavigationBindings_composed, 'NavigationBindings')) {
            ...
            // Advanced annotations:
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)(AnnotationClass.types, (annotationType) => {
    ...
    initEvents() {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)((options.bindings || {}), (value) => {
            navigation.boundClassNames[value.className] = value;
        });
        // Handle multiple containers with the same class names:
        [].forEach.call(bindingsContainer, (subContainer) => {
            navigation.eventsToUnbind.push((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(subContainer, 'click', (event) => {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)((options.events || {}), (callback, eventName) => {
    ...
    annotationToFields(annotation) {
                ...
                if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(option)) {
                    ...
                    option.forEach((arrayOption, i) => {
                        if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(arrayOption)) {
                            ...
                            parent[key][i] = {};
                            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)(arrayOption, (nestedOption, nestedKey) => {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)(options, (option, key) => {
            if (key === 'typeOptions' &&
                ...
                visualOptions[key] = {};
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)(options[key], (typeOption, typeKey) => {
...
class CrookedLine extends Annotations_Annotation {
    ...
    addControlPoints() {
        this.getControlPointsOptions().forEach(function (pointOptions, i) {
            const controlPoint = new Annotations_ControlPoint(this.chart, this, (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(this.options.controlPointOptions, pointOptions.controlPoint), i);
    ...
    addShapes() {
        var _a;
        const typeOptions = (_a = this.options).typeOptions || (_a.typeOptions = {}), shape = this.initShape((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(typeOptions.line, {
            type: 'path',
...
class ElliottWave extends Types_CrookedLine {
    ...
    addLabels() {
        this.getPointsOptions().forEach((point, i) => {
            const typeOptions = this.options.typeOptions, label = this.initLabel((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(point.label, {
...
class Tunnel extends Types_CrookedLine {
    ...
    heightPointOptions(pointOptions) {
        const heightPointOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(pointOptions), typeOptions = this.options.typeOptions;
        heightPointOptions.y += typeOptions.height;
        return heightPointOptions;
    }
    addControlPoints() {
        Types_CrookedLine.prototype.addControlPoints.call(this);
        const options = this.options, typeOptions = options.typeOptions, controlPoint = new Annotations_ControlPoint(this.chart, this, (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(options.controlPointOptions, typeOptions.heightControlPoint), 2);
        this.controlPoints.push(controlPoint);
    ...
    addLine() {
        var _a;
        const line = this.initShape((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(((_a = this.options).typeOptions || (_a.typeOptions = {})).line, {
            type: 'path',
    ...
    addBackground() {
        const background = this.initShape((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(this.options.typeOptions.background, {
            type: 'path',
...
class InfinityLine extends Types_CrookedLine {
    ...
    addShapes() {
        ...
        const line = this.initShape((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(typeOptions.line, {
            type: 'path',
...
class TimeCycles extends Types_CrookedLine {
    ...
    addShapes() {
        ...
        const shape = this.initShape((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(typeOptions.line, {
            type: 'path',
            d: this.getPath(),
    ...
    addControlPoints() {
        ...
        typeOptions.controlPointOptions.forEach((option) => {
            const controlPointsOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(options.controlPointOptions, option);
    ...
    setPathProperties() {
        ...
        const y = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(yValue) ?
            ...
            yAxis.top + yAxis.height, x = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(xValue1) ? xAxis.toPixels(xValue1) : xAxis.left, x2 = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(xValue2) ? xAxis.toPixels(xValue2) : xAxis.left + 30, xAxisLength = xAxis.len, pixelInterval = Math.round(Math.max(Math.abs(x2 - x), 2)), 
...
class Fibonacci extends Types_Tunnel {
    ...
    addLabels() {
        Fibonacci.levels.forEach(function (level, i) {
            const options = this.options.typeOptions, label = this.initLabel((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(options.labels[i], {
                point: function (target) {
...
class FibonacciTimeZones extends Types_CrookedLine {
    ...
    addShapes() {
        ...
        for (let i = 0; i < numberOfLines; i++) {
            ...
            this.initShape((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(this.options.typeOptions?.line, {
                type: 'path',
    ...
    addControlPoints() {
        const options = this.options, typeOptions = options.typeOptions, controlPoint = new Annotations_ControlPoint(this.chart, this, (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(options.controlPointOptions, typeOptions.controlPointOptions), 0);
        this.controlPoints.push(controlPoint);
...
class Pitchfork extends Types_InfinityLine {
    ...
    addBackgrounds() {
        ...
        const innerBackground = this.initShape((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(typeOptions.innerBackground, {
            type: 'path',
            points: [
                function (target) {
        ...
        const outerBackground = this.initShape((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(typeOptions.outerBackground, {
            type: 'path',
            points: [
                this.points[1],
                shapes[1].points[1],
...
class VerticalLine extends Annotations_Annotation {
    ...
    static connectorFirstPoint(target) {
        const annotation = target.annotation, chart = annotation.chart, inverted = chart.inverted, point = annotation.points[0], left = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(point.series.yAxis?.left, 0), top = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(point.series.yAxis?.top, 0), offset = annotation.options.typeOptions?.label?.offset || 0, y = Annotations_MockPoint.pointToPixels(point, true)[inverted ? 'x' : 'y'];
        return {
            x: point.x,
            xAxis: point.series.xAxis,
            y: y + offset +
    ...
    static connectorSecondPoint(target) {
        const annotation = target.annotation, chart = annotation.chart, inverted = chart.inverted, typeOptions = annotation.options.typeOptions, point = annotation.points[0], left = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(point.series.yAxis && point.series.yAxis.left, 0), top = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(point.series.yAxis && point.series.yAxis.top, 0), y = Annotations_MockPoint.pointToPixels(point, true)[inverted ? 'x' : 'y'];
    ...
    addShapes() {
        var _a;
        const typeOptions = this.options.typeOptions, connector = this.initShape((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(typeOptions.connector, {
            type: 'path',
            points: [
    ...
    addLabels() {
        ...
        const label = this.initLabel((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(labelOptions, {
            verticalAlign: verticalAlign,
            align: align,
            x: x,
            y: y
...
class Measure extends Annotations_Annotation {
    ...
    addControlPoints() {
        ...
        if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(this.userOptions.controlPointOptions?.style?.cursor)) {
            if (selectType === 'x') {
...
if (!G.Annotation) {
    G.Annotation = Annotations_Annotation;
...
if (G.Annotation !== Annotations_Annotation && Annotations_Annotation.types) {
    Object.assign(G.Annotation.types, Annotations_Annotation.types);
}
